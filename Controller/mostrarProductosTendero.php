<?php
    ...
    function cargarProductos(){
        ...
        $tendero=$_SESSION['id'];
        $result = $objetoConsultas->mostrarProductos($tendero);
        ...
        if(!isset($result)){
            ...
            foreach ($result as $f) {
                ...
                <td><img src="../'.$f["img_producto"].'" width="70px" ></td>
                    ...
                    <td><a href="editarProductos.php?id_productos='.$f["id_productos"].'" class="btn btn-primary">VER/MODIFICAR</a> </td>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" class="form-control" value="'.$f["cantidad_producto"].'" id="cantidad_producto" required name="cantidad_producto" placeholder="Ejemplo: 46">
                    </div>
