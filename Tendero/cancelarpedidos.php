  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Mostrar pedidos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-8">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Formulario De cancelacion de pedidos</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="../../Controller/cancelacionPedidos.php" method="POST">
                <div class="card-body">
                  <div class="row">
                    
                                
                <div class="form-group">
                  <label for="cancelacion_pedido">Motivo de cancelación del pedido</label>
                  <textarea class="form-control" id="cancelacion_pedido" rows="9" require></textarea>
                </div>
