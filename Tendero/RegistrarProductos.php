        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="../../Controller/insertarProductos.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                  <input type="hidden" class="form-control" id="id_producto"  value="<?php echo"$id_user"?>" name="id_user" placeholder="Ej:123456" required>
